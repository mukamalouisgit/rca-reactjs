...
let UsersController = class UsersController {
    ...
    change_password(updateUserDto, file) {
        return this.usersService.change_password(updateUserDto);
    }
    confirm_registration(id) {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], UsersController.prototype, "forget_password", null);
__decorate([
    ...
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('profile_photo', {
        storage: (0, multer_1.diskStorage)({
            ...
            filename: (req, profile_photo, cb) => {
                ...
                return cb(null, `${randomName}${(0, path_1.extname)(profile_photo.originalname)}`);
            }
        })
    })),
    __param(0, (0, common_1.Body)()),
...
__decorate([
    ...
    __metadata("design:paramtypes", [update_user_dto_1.UpdateUserDto, Object]),
    __metadata("design:returntype", void 0)
], UsersController.prototype, "change_password", null);
__decorate([
    (0, common_1.Put)('confirm-registration/:id'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], UsersController.prototype, "confirm_registration", null);
__decorate([
...
__decorate([
    (0, common_1.Get)('/profile/:imgpath'),
